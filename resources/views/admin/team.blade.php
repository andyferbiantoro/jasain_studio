         ...
         <div class="table-responsive">
          ...
          <tbody>
            ...
            <tr>
              <td>{{$no++}}</td>
              <td>{{$data->nama}}</td>
              <td>{{$data->posisi_team}}</td>
              <td style="text-align: center;"><img height="70" id="myImg" src="{{asset('uploads/foto_tim/'.$data->image)}}"  data-toggle="modal" data-target="#myModal"></img></td>
              <td>
              <td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="{{route('admin_team_add')}}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="posisi_team">Posisi Team</label>
            <input type="text" class="form-control" id="posisi_team" name="posisi_team" required="" />
          </div>
      ...
      <form action="" id="updateModalform" method="post" enctype="multipart/form-data">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="posisi_team">Posisi Team</label>
              <input type="text" class="form-control" id="posisi_team_update" name="posisi_team" required="" />
            </div>
...
<script type="text/javascript">
  function deleteData(id) {
    var id = id;
    var url = '{{route("admin_team_delete", ":id") }}';
...
<script>
  $(document).ready(function() {
    ...
    table.on('click', '.edit', function() {
      ...
      $('#posisi_team_update').val(data[2]);
      $('#updateModalform').attr('action','admin_team_update/'+ data[4]);
