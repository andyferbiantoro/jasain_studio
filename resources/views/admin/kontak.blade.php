  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="{{route('admin_kontak_add')}}" enctype="multipart/form-data">
    ...
    <form action="" id="updateModalform" method="post" enctype="multipart/form-data">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="nohp">No HP</label>
            <input type="text" class="form-control" id="nohp_update" name="nohp" required="" />
          </div>
...
<script type="text/javascript">
  function deleteData(id) {
    var id = id;
    var url = '{{route("admin_kontak_delete", ":id") }}';
...
<script>
  $(document).ready(function() {
    ...
    table.on('click', '.edit', function() {
      ...
      $('#updateModalform').attr('action','admin_kontak_update/'+ data[4]);
