  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="{{route('admin_portofolio_add')}}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="jenis_project">Jenis Projek</label>
            <select type="text" class="form-control" id="jenis_project" name="jenis_project" required="">
           ...
           <div class="form-group">
            <label for="image">Image Peojek</label>
      ...
      <form action="" id="updateModalform" method="post" enctype="multipart/form-data">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="jenis_project">Jenis Projek</label>
              <select type="text" class="form-control" id="jenis_project_update" name="jenis_project" required="">
                <option >Website</option>
                <option >Android</option>
                <option >Desain Grafis</option>
              </select>
...
<script type="text/javascript">
  function deleteData(id) {
    var id = id;
    var url = '{{route("admin_portofolio_delete", ":id") }}';
...
<script>
  $(document).ready(function() {
    ...
    table.on('click', '.edit', function() {
      ...
      $('#updateModalform').attr('action','admin_portofolio_update/'+ data[5]);
