        ...
        <table id="dataTable" class="table table-hover">
          ...
          <tbody>
            ...
            <tr>
              <td>{{$no++}}</td>
              <td>{{$data->judul}}</td>
              <td style="text-align: center;"><img height="70" id="myImg" src="{{asset('uploads/galeri/'.$data->image)}}"  data-toggle="modal" data-target="#myModal"></img>
                <td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="{{route('admin_galeri_add')}}" enctype="multipart/form-data">
...
<script type="text/javascript">
  function deleteData(id) {
    var id = id;
    var url = '{{route("admin_galeri_delete", ":id") }}';
...
<script>
  $(document).ready(function() {
    ...
    table.on('click', '.edit', function() {
      ...
      $('#updateModalform').attr('action','admin_galeri_update/'+ data[4]);
