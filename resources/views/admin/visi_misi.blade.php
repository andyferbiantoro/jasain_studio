      ...
      <form action="" id="updateModalform" method="post" enctype="multipart/form-data">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="visi">Visi</label>
              <input type="text" class="form-control" id="visi_update" name="visi" required="" />
            </div>

            <div class="form-group">
              <label for="misi">Misi</label>
              <input type="text" class="form-control" id="misi_update" name="misi" required="" />
            </div>
...
<script>
  $(document).ready(function() {
    ...
    table.on('click', '.edit', function() {
      ...
      $('#updateModalform').attr('action','admin_visi_misi_update/'+ data[4]);
