  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="{{route('admin_testimoni_add')}}" enctype="multipart/form-data">
      ...
      <form action="" id="updateModalform" method="post" enctype="multipart/form-data">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="isi">Isi Testimoni</label>
              <input type="text" class="form-control" id="isi_update" name="isi" required="" />
            </div>
...
<script type="text/javascript">
  function deleteData(id) {
    var id = id;
    var url = '{{route("admin_testimoni_delete", ":id") }}';
...
<script>
  $(document).ready(function() {
    ...
    table.on('click', '.edit', function() {
      ...
      $('#isi_update').val(data[2]);
      $('#updateModalform').attr('action','admin_testimoni_update/'+ data[5]);
